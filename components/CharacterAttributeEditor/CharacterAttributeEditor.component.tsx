...
export const AttItem = overridable(({ item: att, update, remove, classes = styles }: { item: ICharacterAttribute } & ILinkItemProps) => {
    return <div className={classes.att}>
